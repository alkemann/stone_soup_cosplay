...
<dl>
	<dt>Species</dt>
		<dd>Draconian</dd>
	<dt>Background</dt>
		<dd>Gladiator (with quarterstaff)</dd>
	<dt>God</dt>
		<dd>Fedhas or Qazlal</dd>
</dl>
...
<dl>
	<dt>Weapons</dt>
		<dd>Train only Fighting, Staves, Unarmed Combat, and Throwing for weapon skills.</dd>
	<dt>Magic</dt>
		<dd>Don't learn or cast any necromancy spells.</dd>
	<dt>Evocations</dt>
		<dd>Have three different rechargeable evocables in your inventory. (Possible items: lamp of fire, phial of floods, fan of gales, lightning rod, and the Horn of Geryon.)</dd>
</dl>
...
<dl>
	<dt>Tempestuous</dt>
		<dd>Reach skill level 27 in invocations, before you reach XL27. (Sorry agentoutlier! I'm moving away from these for the future but there will still be a couple once in a while.)</dd>
	<dt>The Dragon Experience</dt>
		<dd> Be in dragon form from the time you enter Zot onward, and win the game. You don't have to be in dragon form for resting/auto-travel/running away/etc.
